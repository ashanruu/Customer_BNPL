...
type RootStackParamList = {
  ...
  ReEnterNewPinScreen: { pin: string };
  ForgotPinScreen: undefined;
};

type EnterNewPinScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'EnterNewPinScreen'
>;

const EnterNewPinScreen: React.FC = () => {
  const navigation = useNavigation<EnterNewPinScreenNavigationProp>();
  ...
  const handleNext = () => {
    if (pin.length === 4) {
      ...
      navigation.navigate('ReEnterNewPinScreen', { pin });
    }
  };
