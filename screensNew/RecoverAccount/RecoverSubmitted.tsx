...
const RecoverSubmittedScreen: React.FC = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.title}>We’ve Received{'\n'}Your Request</Text>

                <Text style={styles.body}>
                    We have received your account recovery request and it's now under review.
                </Text>

                <Text style={styles.body}>
                    Our support team will contact you within <Text style={{ fontWeight: '700' }}>2 working days</Text> to verify your details and assist you with recovering your account.
                </Text>
...
export default RecoverSubmittedScreen;