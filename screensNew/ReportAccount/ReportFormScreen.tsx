...
const ReportFormScreen: React.FC = () => {
    ...
    const handleSubmit = () => {
        ...
        navigation.navigate('ReportSubmitted' as any);
    };
    ...
    return (
        <ScreenTemplate
            ...
            topTitle="This isn't your account,"
            mainTitle="Report This Account"
        ...
        >
            <View style={styles.container}>
                ...
                <Text style={styles.fieldLabel}>Reachable WhatsApp Number</Text>
                ...
                <TouchableOpacity style={styles.uploadBox} onPress={handleUpload} activeOpacity={1}>
                    <View style={styles.uploadLeft}>
                        ...
                        <Text style={styles.uploadDesc}>
                            Upload National Identity Card, Passport or Driving license
                        </Text>
                    </View>
